...
import { formatBaselineUpdateDone, formatDiffResults, formatCaptureDone, } from './formatter.js';
...
program
    ...
    try {
        if (opts.baselineUpdate || opts.updateBaselines) {
            const updated = await updateBaselineSnapshots(opts.url, config.defaultSelectors, width, config.snapshotsDir);
